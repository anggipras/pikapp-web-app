                    ...
                    <Row>
                        ...
                        <Col xs={6} md={4}>
                            <ButtonGroup className={"modalButtonGroup"}>
                                <Button onClick={() => this.handleDecrease(food)} variant= "modalMiniButton">-</Button>
                                <Form.Control value={food.amount} className= "modalField" disabled></Form.Control>
                                <Button onClick={() => this.handleIncrease(food)} variant= "modalMiniButton">+</Button>
                            </ButtonGroup>
                        </Col>
                    </Row>
                </>
                ...
                <Modal.Body>
                    ...
                    <Row>
                        ...
                        <Form>
                            ...
                            <Form.Control placeholder = {"Tambahkan catatanmu"} className = {"modalNote"} fluid></Form.Control>
                        </Form>
                        </Col>
                    </Row>
                    <Row>
                        <Col xs={1} md={2}/>
                        <Col xs={10} md={8}>
                            <PikaButton title='Add to cart' buttonStyle='modalPika' handleClick = {this.props.handleClick}/>
                        </Col>
                        <Col xs={1} md={2}/>
                    </Row>
                </Modal.Body>
